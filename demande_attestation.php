 ...
 */
    ...
    class demande_attestationPage extends Page
    {
        ...
        protected function setupFilterBuilder(FilterBuilder $filterBuilder, FixedKeysArray $columns)
        {
            ...
            $main_editor->SetHandlerName('filter_builder_demande_attestation_ID_Utilis_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('ID_Utilis', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_demande_attestation_ID_Utilis_search');
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            $editColumn = new DynamicLookupEditColumn('ID Utilis', 'ID_Utilis', 'ID_Utilis_Nom_Utilis', 'edit_demande_attestation_ID_Utilis_search', $editor, $this->dataset, $lookupDataset, 'ID_Utilis', 'Nom_Utilis', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
        ...
        protected function AddMultiEditColumns(Grid $grid)
        {
            ...
            $lookupDataset->setOrderByField('Nom_Utilis', 'ASC');
            $editColumn = new DynamicLookupEditColumn('ID Utilis', 'ID_Utilis', 'ID_Utilis_Nom_Utilis', 'multi_edit_demande_attestation_ID_Utilis_search', $editor, $this->dataset, $lookupDataset, 'ID_Utilis', 'Nom_Utilis', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddMultiEditColumn($editColumn);
        ...
        protected function AddInsertColumns(Grid $grid)
        {
            ...
            $lookupDataset->setOrderByField('Nom_Utilis', 'ASC');
            $editColumn = new DynamicLookupEditColumn('ID Utilis', 'ID_Utilis', 'ID_Utilis_Nom_Utilis', 'insert_demande_attestation_ID_Utilis_search', $editor, $this->dataset, $lookupDataset, 'ID_Utilis', 'Nom_Utilis', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddInsertColumn($editColumn);
        ...
        protected function doRegisterHandlers() {
            ...
            $lookupDataset->setOrderByField('Nom_Utilis', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'insert_demande_attestation_ID_Utilis_search', 'ID_Utilis', 'Nom_Utilis', null, 20);
            ...
            $lookupDataset->setOrderByField('Nom_Utilis', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_demande_attestation_ID_Utilis_search', 'ID_Utilis', 'Nom_Utilis', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('Nom_Utilis', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'edit_demande_attestation_ID_Utilis_search', 'ID_Utilis', 'Nom_Utilis', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('Nom_Utilis', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'multi_edit_demande_attestation_ID_Utilis_search', 'ID_Utilis', 'Nom_Utilis', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
        }
    ...
    try
    {
        $Page = new demande_attestationPage("demande_attestation", "demande_attestation.php", GetCurrentUserPermissionsForPage("demande_attestation"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("demande_attestation"));
