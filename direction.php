 ...
 */
    ...
    class directionPage extends Page
    {
        ...
        {
            return array(
                new FilterColumn($this->dataset, 'ID_Dir', 'ID_Dir', 'ID Dir'),
        ...
        {
            $main_editor = new TextEdit('id_dir_edit');
        ...
        {
            if ($chart->getId() === 'Direction_M_Mme') {
    ...
    try
    {
        $Page = new directionPage("direction", "direction.php", GetCurrentUserPermissionsForPage("direction"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("direction"));
