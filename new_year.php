 ...
 */
    ...
    class new_yearPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('New Year');
            $this->SetMenuLabel('New Year');
            ...
            $this->dataset->addFields(
                array(
                    new IntegerField('ID_Year', true, true, true),
                    new StringField('Statut', true),
        ...
        {
            return array(
                new FilterColumn($this->dataset, 'ID_Year', 'ID_Year', 'ID Year'),
        ...
        {
            $main_editor = new TextEdit('id_year_edit');
        ...
        {
            //
            // View column for ID_Year field
            //
            $column = new NumberViewColumn('ID_Year', 'ID_Year', 'ID Year', $this->dataset);
            ...
            //
            $column = new TextViewColumn('Statut', 'Statut', 'Statut', $this->dataset);
            $column->SetOrderable(true);
    ...
    try
    {
        $Page = new new_yearPage("new_year", "new_year.php", GetCurrentUserPermissionsForPage("new_year"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("new_year"));
