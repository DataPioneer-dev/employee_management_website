...
<div class="custom-filter-container">
    <form class="js-custom-filter-container" method="get">
        <ul class="nav nav-pills pull-right grid-card-column-filter">
            <li {if $DemandeCongeFilterActive}class="active"{/if}>
                        ...
                        <table width="100%">
                            <tr>
                                <td width="45%">
                                    ...
                                    <input type="text" data-editor="text" id="Nom" class="form-control input-sm" value="{$DemandeCongeFilter.Nom}">
                                </td>
                                <td width="10%">&nbsp;</td>
                                <td width="45%">
                                    <label for="Prenom">Prénom</label>
                                    <input type="text" data-editor="text" id="Prenom" class="form-control input-sm" value="{$DemandeCongeFilter.Prenom}">
                                </td>
                            </tr>
                            <tr>
                <td colspan="3">
                    <label for="DateDemande">Date de demande</label>
                    <input id="DateDemande" data-editor="datetime" data-pgui-legacy-validate="true" class="form-control" type="date" value="{$DemandeCongeFilter.DateDemande}" data-picker-format="DD-MM-YYYY" data-picker-show-time="false">
                </td>
            </tr>
                        </table>
                    </div>
