 ...
 */
    ...
    class corpsPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Corps');
            $this->SetMenuLabel('Corps');
        ...
        {
            return array(
                new FilterColumn($this->dataset, 'ID_Cor', 'ID_Cor', 'ID Cor'),
        ...
        {
            $main_editor = new TextEdit('id_cor_edit');
    ...
    try
    {
        $Page = new corpsPage("corps", "corps.php", GetCurrentUserPermissionsForPage("corps"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("corps"));
