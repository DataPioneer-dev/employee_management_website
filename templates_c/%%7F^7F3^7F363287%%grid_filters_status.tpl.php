<?php if (( $this->_tpl_vars['DataGrid']['FilterBuilder']->hasColumns() || $this->_tpl_vars['DataGrid']['ColumnFilter']->hasColumns() || $this->_tpl_vars['DataGrid']['QuickFilter']->hasColumns() || $this->_tpl_vars['FilterStatus'] )): ?>
