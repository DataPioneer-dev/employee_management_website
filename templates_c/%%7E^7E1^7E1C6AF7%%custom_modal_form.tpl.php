...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'string_format', 'custom_templates/custom_modal_form.tpl', 58, false),)), $this); ?>
...
">
 ...
 le profil de <?php echo $this->_tpl_vars['Nom']; ?>
 <?php echo $this->_tpl_vars['Prenom']; ?>
</h4>
        </div>
        ...
        <div class="modal-footer">
            <div class="btn-toolbar pull-right">
                ...
                <div class="btn-group">
                    ...
                    <?php if (! $this->_tpl_vars['isNested'] && ! $this->_tpl_vars['isMultiEditOperation']): ?>
