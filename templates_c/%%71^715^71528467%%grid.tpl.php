...
"
        <?php if ($this->_tpl_vars['DataGrid']['ReloadPageAfterAjaxOperation']): ?>data-reload-page-after-ajax-operation="true"<?php endif; ?>
        <?php echo $this->_tpl_vars['DataGrid']['Attributes']; ?>
>

    <?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => $this->_tpl_vars['GridToolbarTemplate'], 'smarty_include_vars' => array()));
