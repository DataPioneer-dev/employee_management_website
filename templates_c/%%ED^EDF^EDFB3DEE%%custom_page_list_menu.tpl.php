...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escapeurl', 'custom_templates/custom_page_list_menu.tpl', 27, false),)), $this); ?>
        ...
        <?php if ($this->_tpl_vars['GroupCaption'] != 'Default'): ?>
            <li class="dropdown">
                ...
                <ul class="dropdown-menu", id="Services">
                    <?php if ($this->_tpl_vars['GroupCaption'] == 'Services'): ?>
                        <li>
                            <a href="#" data-toggle="modal" data-target="#langue_attest_1">Demande d'attestation de travail</a>
                        </li>
                    <?php endif; ?>
        <?php endif; ?>
