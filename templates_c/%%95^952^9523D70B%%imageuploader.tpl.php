...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escapeurl', 'editors/imageuploader.tpl', 38, false),)), $this); ?>
<?php if (! $this->_tpl_vars['Editor']->GetReadOnly()): ?>
    <?php if ($this->_tpl_vars['Editor']->GetShowImage()): ?>
        <img src="<?php if ($this->_tpl_vars['Editor']->GetLink()): ?><?php echo $this->_tpl_vars['Editor']->GetLink(); ?>
<?php else: ?>#<?php endif; ?>" style="<?php if (! $this->_tpl_vars['Editor']->GetLink()): ?>display: none;<?php endif; ?>max-width: 100%;<?php echo $this->_tpl_vars['Editor']->getInlineStyles(); ?>
">
    <?php endif; ?>
...
_action" data-toggle="buttons-radio">
            ...
            <button type="button" value="Replace" class="btn btn-default js-replace" data-toggle="button" disabled="disabled"><?php echo $this->_tpl_vars['Captions']->GetMessageString('ReplaceImage'); ?>
</button>
        </div>
    </div>
